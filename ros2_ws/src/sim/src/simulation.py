...
class BasicSimulation:
    ...
    def apply_control(self):
        ...
        # Convert linear velocity [m/s] to wheel angular velocity [rad/s]
        wheel_velocity = vel / self.wheel_radius
        ...
        for joint in self.wheel_joints:
            p.setJointMotorControl2(
                ...
                force=50  # increased for better tracking
            )
    ...
    def reset_car(self, position=[0, 0, 0.05], orientation=[0, 0, 0, 1]):
